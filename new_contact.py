...
class NewContact(unittest.TestCase):
    ...
    def test_new_contact(self):
        ...
        self.log_in(wd, user_name="admin", user_password="secret")
        self.open_create_contact_page(wd)
        self.add_new_contact(wd, Contact(first_name="Preved!", middle_name="Bonjour!", last_name="Zdarova!", nickname="Gutentag!", title="Bonapetit",
    ...
    def log_in(self, wd, user_name, user_password):
